...
| --- | --- | --- | --- | --- | --- | --- |
| Markdown Editor | `markdown-editor/` | `index.html`, `script.js`, `js/`, `i18n.js`, `config.js`, `style.css` | `README.md` | `tests/`, `playwright.config.js` | `images/`, `template/`, `docs/`, `i18n/` | marked / Mermaid (CDN), `LICENSE`, package metadata for npm dev dependencies |
